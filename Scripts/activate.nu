...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Dawid\IICE-PYTHON\Book\ForLoop-CharChains-And-Tuple'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Dawid\IICE-PYTHON\Book\ForLoop-CharChains-And-Tuple\Scripts\deactivate.nu'
